...
Pid_Position_t motor_pitch_speed_pid = NEW_POSITION_PID(280, 30, 0.5, 220, 30000, 0, 1000, 500); //pitch����ٶ�PID
Pid_Position_t motor_pitch_angle_pid = NEW_POSITION_PID(0.18, 0.01, 0.002, 100, 300, 0, 3000, 500); //pitch����Ƕ�PID
